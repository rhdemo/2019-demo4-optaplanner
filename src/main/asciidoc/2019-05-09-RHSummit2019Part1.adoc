...
In the Operations Research world, this problem is known as the Vehicle Routing Problem (VRP),
...
Their are the same problem, with a few variations on the constraints.
...
This also leads to heavy reductions in fuel consumption,
decreasing their carbon footprint, which is a win-win for the environment too!
...
After all, we couldn't risk that it crashed in front of 8000 people
(including all our bosses, all the way up to our CEO).
