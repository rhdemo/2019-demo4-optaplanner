...
These systems should monitor, automate and maintain these devices in an robust and efficient way.
...
and automatically dispatches mechanics to fix them in a smart way. To learn more about the use case and challenge,
read https://www.optaplanner.org/blog/2019/05/09/2019-05-09-RHSummit2019Part1.html[Part 1 by Geoffrey].
...
read https://www.optaplanner.org/blog/2019/05/09/2019-05-09-RHSummit2019Part3.html[Part 3 by Radovan].
