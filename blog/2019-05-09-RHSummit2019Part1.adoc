...
Luckily, OptaPlanner can schedule those mechanics for us, in real-time, as shown in this video:
...
which is the amount of time the mechanics need to fix all the machines once.
